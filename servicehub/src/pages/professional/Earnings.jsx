...
const transactions = [
  { id: 'TXN001', service: 'Wiring', customer: 'Amit Gupta', date: '2026-02-22', amount: 600, status: 'Paid' },
  { id: 'TXN002', service: 'Panel Upgrade', customer: 'Sneha Roy', date: '2026-02-18', amount: 1200, status: 'Paid' },
  { id: 'TXN003', service: 'Lighting', customer: 'Kavita Joshi', date: '2026-02-15', amount: 450, status: 'Paid' },
  { id: 'TXN004', service: 'Smart Home Setup', customer: 'Rohan Das', date: '2026-02-10', amount: 2500, status: 'Pending' },
]
    ...
    <div>
      ...
      <div className="stats-grid">
        ...
        <div className="card stat-card">
          ...
          <div className="stat-value">{'₹'}{Math.round(totalEarnings / mockEarnings.length).toLocaleString()}</div>
      ...
      <div className="card" style={{ padding: '24px' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '16px' }}>Transaction History</h3>
